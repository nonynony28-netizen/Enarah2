        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 ${isAr ? 'text-right' : 'text-left'}`}>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2.5">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-blue-600 border border-slate-200 text-slate-700 hover:text-white text-xs font-semibold transition-all duration-200"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-pink-600 border border-slate-200 text-slate-700 hover:text-white text-xs font-semibold transition-all duration-200"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-900 border border-slate-200 text-slate-700 hover:text-white text-xs font-semibold transition-all duration-200"
              >
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-slate-600 hover:text-blue-600 text-xs sm:text-sm transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className={`flex items-center gap-2.5 text-slate-600 text-xs sm:text-sm ${isAr ? 'justify-start' : 'justify-start'}`}>
              ...
              <li className={`flex items-center gap-2.5 text-slate-600 text-xs sm:text-sm ${isAr ? 'justify-start' : 'justify-start'}`}>
                ...
                <a href="mailto:info@enarahmodern.com" className="hover:text-blue-600 transition-colors">
                  info@enarahmodern.com
                </a>
              </li>

              <li className={`flex items-start gap-2.5 text-slate-600 text-xs sm:text-sm leading-relaxed ${isAr ? 'justify-start' : 'justify-start'}`}>
