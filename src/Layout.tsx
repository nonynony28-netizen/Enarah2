  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <div className="fixed inset-0 -z-50 w-full h-full bg-[#050b14] overflow-hidden pointer-events-none">
        ...
        <div className="absolute -inset-[50%] w-[200%] h-[200%] bg-ultra-ambient animate-slow-rotate opacity-60"></div>
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#050b14]/50 via-transparent to-[#050b14]/70"></div>
      </div>
