      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center mb-16 md:mb-20">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight tracking-tight text-white">
            {isAr ? (
              <>معرض <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 drop-shadow-[0_4px_20px_rgba(59,130,246,0.4)]">المنتجات</span></>
            ) : (
              <>Products <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-400 drop-shadow-[0_4px_20px_rgba(59,130,246,0.4)]">Gallery</span></>
            )}
          </h1>
              ...
              {dynamicCategories.map((cat, i) => {
                return (
                  <motion.div
                    ...
                    className="group relative rounded-3xl bg-[#0f213a] border border-white/10 overflow-hidden hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-1.5 shadow-xl flex flex-col h-full cursor-pointer"
                  >
                    ...
                    <div className="p-6 flex flex-col flex-grow justify-between">
                      ...
                      <div className="pt-4 border-t border-white/5 flex items-center justify-between mt-auto">
                        <span className="text-xs font-black text-blue-400 group-hover:text-sky-300 transition-colors duration-300 flex items-center gap-2">
        ...
        {!loading && selectedCategory !== 'all' && (
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-10 p-6 rounded-2xl bg-[#0c1e38] border border-blue-500/30 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs sm:text-sm transition-all active:scale-95 cursor-pointer shadow-[0_0_15px_rgba(59,130,246,0.3)]"
            >
                        ...
                        className={`w-full py-3.5 border transition-all duration-300 font-bold text-sm flex items-center justify-center gap-2 rounded-xl shadow-sm cursor-pointer ${
                          product.stockStatus === 'out_of_stock' || (product.stockQty !== undefined && product.stockQty <= 0)
                            ...
                            : addingId === product.id
                              ...
                              : 'bg-blue-600/15 hover:bg-blue-600 border-blue-500/30 hover:border-blue-400 text-blue-400 hover:text-white hover:shadow-[0_0_20px_rgba(59,130,246,0.4)]'
                        }`}
                      >
