...
import { PlayCircle, PackageSearch, Loader2, ArrowRight, ChevronRight, ChevronLeft, X } from 'lucide-react'
...
export default function Projects() {
  ...
  return (
    <div className="pt-24 md:pt-32 pb-24 bg-[#0a192f] min-h-screen relative overflow-hidden text-white font-sans" dir="rtl">
