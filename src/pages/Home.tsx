                    ...
                    {showText && (
                      ...
                      >
                        ...
                        <div className="mt-4 sm:mt-6 flex flex-wrap items-center justify-center gap-3">
                          <Link
                            to="/game"
                            className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-xs sm:text-sm transition-all active:scale-95 shadow-md cursor-pointer"
                          >
                            <Gamepad2 className="w-4 h-4" />
                            <span>{isAr ? '🎮 العب لعبة رحلة النور واكسب كود خصم' : '🎮 Play Light Quest & Win Discount'}</span>
                          </Link>
                        </div>
                      </motion.div>
                    )}
